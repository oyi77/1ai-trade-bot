...
def generate_briefing():
    ...
    lines.extend([
        ...
        f"   └ Support: <b>🔒 Unlock →</b> /subscribe",
        f"   └ Resistance: <b>🔒 Unlock →</b> /subscribe",
        f"",
        f"🔒 <b>[DONOR ONLY]</b> Entry Strategy:",
        f"   └ Buy Zone: <b>🔒 Unlock →</b> /subscribe",
        f"   └ Sell Zone: <b>🔒 Unlock →</b> /subscribe",
        f"",
        f"🔒 <b>[DONOR ONLY]</b> Risk Parameters:",
        f"   └ SL Placement: <b>🔒 Unlock →</b> /subscribe",
        f"   └ TP Targets: <b>🔒 Unlock →</b> /subscribe",
        f"",
        f"📰 <b>[DONOR ONLY]</b> News Risk Today:",
        f"   └ High-impact events: <b>🔒 Unlock →</b> /subscribe",
        f"   └ Red folder sessions: <b>🔒 Unlock →</b> /subscribe",
        f"",
    ])
    ...
    lines.extend([
        ...
        f"   👉 <b>/subscribe</b> — Unlock briefing lengkap",
        f"",
