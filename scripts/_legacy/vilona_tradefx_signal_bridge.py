...
class SignalHandler(BaseHTTPRequestHandler):
    ...
    def _format_signal(self, sig):
        ...
        return {
            ...
            "zone_lo": sig.get("zone_lo", sig.get("zone_low")),
            "zone_hi": sig.get("zone_hi", sig.get("zone_high")),
            "zone_low": sig.get("zone_low", sig.get("zone_lo")),
            "zone_high": sig.get("zone_high", sig.get("zone_hi")),
