...
class CommandHandlersMixin(BaseBot):
    ...
    async def _cmd_help(self, args: list[str], chat_id: str | None = None) -> str:
        lines = [
            ...
            "/subscribe — Info subscription & pricing",
    ...
    async def _cmd_donate_manual(self, args: list[str], chat_id: str | None = None) -> str:
        ...
        try:
            ...
            invoice = create_tripay_invoice(
                target, amount, f"Subscribe {target} - Rp{amount:,}"
            )
    ...
    async def _cmd_settings(self, args: list[str], chat_id: str | None = None) -> str:
        ...
        return (
            ...
            f"━━━━━━━━━━━━━━━━\n"
            f"👑 Subscriber: {'Yes ✅' if is_donor else 'No ❌'}\n"
            f"📊 Risk: {risk}\n"
            f"🕐 TF Default: {tf}\n"
            f"🤖 Autosync: {autosync}\n"
