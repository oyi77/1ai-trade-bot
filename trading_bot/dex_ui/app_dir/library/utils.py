...
async def get_balance_async(web3, address, token_address=None, aw3=None):
    ...
    if token_address:
        ...
        balance = await aw3._run_sync(lambda: contract.functions.balanceOf(web3.to_checksum_address(address)).call())
    else:
        balance = await aw3.eth_get_balance(web3.to_checksum_address(address))
    return web3.from_wei(balance, 'ether')
