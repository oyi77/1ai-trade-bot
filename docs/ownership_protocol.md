...
Halt on: broken architecture · failing tests · security holes · stale docs · invalid assumptions.

Then: Stop → Explain what broke → Write fix plan → Execute → Continue.

---

## DONE =
Works + Tests pass + Edges handled + No hidden assumptions + Docs synced + Self-reviewed + Production-ready.
...
## HARD NOs : Fake APIs · Mocked prod logic · Placeholders · Dead code · Shortcuts · "Good enough" · Half-done · Unverified assumptions.